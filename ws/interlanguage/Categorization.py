...
class Categorization:
        ...
        for page in pages:
            ...
            if "categories" in page:
                for cat in page["categories"]:
                    ...
                    if (
                        page["title"] == f"Category:{langname}"
                        and cat["title"] == "Category:Languages"
                    ):
                        continue
    ...
    @staticmethod
    def fix_page(title: str, text_old: str) -> Wikicode:
        ...
        for cat in cats:
            ...
            if ln != langname:
                ...
                cat.title = lang.format_title(pure, langname)  # type: ignore
    ...
    def fix_allpages(self) -> None:
        ...
        for chunk in ws.utils.iter_chunks(pageids, self.api.max_ids_per_query):
            ...
            for page in pages.values():
                logger.info(
                    f"Fixing language of categories on page [[{page['title']}]]..."
                )
