...
class TableOfContents(ConfigurableObject):
    ...
    def set_argparser(argparser: argparse.ArgumentParser) -> None:
        ...
        group.add_argument(
            ...
            help="the page name on the wiki to fetch and update (the language suffix is added automatically as necessary) (default: %(default)s)",
        )
    ...
    def parse_toc_table(self, title: str, toc_table: Tag | None) -> tuple[list[str], dict[str, str], dict[str, str]]:
        ...
        for title in self.titles:
            ...
            if toc_table is None:
                if self.cliargs.save is True:
                    ...
                    logger.warning("The wiki page [[{}]] does not contain the ToC table, so there will be no translations.".format(title))
