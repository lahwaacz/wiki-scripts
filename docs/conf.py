...
# -*- coding: utf-8 -*-
#
# wiki-scripts documentation build configuration file, created by
# sphinx-quickstart on Sun Aug 10 19:35:26 2014.
#
...
# Import the module we are documenting (to e.g. get its version).
import ws
...
copyright = "2014-2023, Jakub Klinkovský"
...
# pixels large.
html_favicon = "./_static/wiki-scripts.ico"
...
latex_documents = [
    ("index", "wiki-scripts.tex", "wiki-scripts Documentation", "lahwaacz", "manual"),
]
...
man_pages = [
    ("index", "wiki-scripts", "wiki-scripts Documentation", ["lahwaacz"], 1),
]
...
texinfo_documents = [
    ("index", "wiki-scripts", "wiki-scripts Documentation", "lahwaacz", "wiki-scripts", "One line description of project.", "Miscellaneous"),
]
