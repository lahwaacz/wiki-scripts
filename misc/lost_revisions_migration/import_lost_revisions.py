...
def migrate(revision, username_to_id):
    ...
    return {
        ...
        "ar_timestamp": datetime.datetime.strptime(revision["timestamp"], "%Y-%m-%dT%H:%M:%S"),
...
if __name__ == "__main__":
    ...
    username_to_id = {userprops["name"]: userprops["userid"] for userprops in db.query(list="allusers")}
    ...
    migrated_revisions = [migrate(revision, username_to_id) for revision in revisions_to_import]
