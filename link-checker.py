...
from ws.checkers import get_edit_summary_tracker, localize_flag, CheckerBase, WikilinkChecker
...
class ManTemplateRules(CheckerBase):
...
class LinkChecker(ExtlinkRules, WikilinkChecker, ManTemplateRules):
