...
class test_getters:
    def _test(self, values: list[str], getter: Callable) -> None:
        result = getter()
...
#    def test_tags_concatenation(self) -> None:
...
class test_detect_language:
    ...
    def test_suite(self, title: str, expected: tuple[str, str]) -> None:
        assert detect_language(title) == expected

    @pytest.mark.parametrize("lang", language_names)
    def test_all_langs(self, lang: str) -> None:
        assert detect_language("foo ({})".format(lang)) == ("foo", lang)

    @pytest.mark.parametrize("lang", language_names)
    def test_all_cats(self, lang: str) -> None:
...
class test_format_title:
    ...
    def test_invalid_langname(self) -> None:
