...
class test_expand_templates(common_base):
    ...
    def test_noinclude_and_includeonly_and_onlyinclude(self, title_context: Context) -> None:
        d = {
    ...
    def test_nested_noinclude_and_includeonly_and_onlyinclude(self, title_context: Context) -> None:
        d = {
...
class test_transclusion_modifiers(common_base):
    ...
    def test_subst_existing_template(self, title_context: Context, modifier: str) -> None:
        d = {
            "Template:Echo": "{{{1}}}",
    ...
    @pytest.mark.parametrize("modifier", ["subst", "safesubst"])
    def test_subst_existing_template_two(self, title_context: Context, modifier: str) -> None:
        d = {
            "Echo": "{{{1}}}",
